            ...
            <div className="w-full" style={{ flexBasis: "90px" }}>
              ...
              >
                ...
                <IconButton style={{color: "#404040"}}aria-label="like">
                 <ThumbUpIcon/>
				  <span style={{fontSize:9, paddingLeft:"4px"}}>{postData.upVoteCount}</span>
                </IconButton>
				<IconButton style={{color: "#404040"}} aria-label="dislike">
                 <ThumbDownIcon/>
				 <span style={{fontSize:9, paddingLeft:"4px"}}>{postData.downVoteCount}</span>
                </IconButton>
				...
				<Divider/>
				 ...
				 <div>
                 <Rating name="read-only" value={5*(postData.expertUpVoteCount/(postData.expertUpVoteCount + postData.expertDownVoteCount))} readOnly />
    </div>
